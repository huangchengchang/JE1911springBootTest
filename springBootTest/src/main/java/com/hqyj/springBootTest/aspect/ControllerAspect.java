package com.hqyj.springBootTest.aspect;
...
public class ControllerAspect {
	 ...
	 */
	@Pointcut("execution(public * com.hqyj.springBootTest.modules.*.controller.*.*(..))")
	@Order(1)
	public void controllerPointCut() {}
	
	@Before(value = "com.hqyj.springBootTest.aspect.ControllerAspect.controllerPointCut()")
	...
	@Around(value="com.hqyj.springBootTest.aspect.ControllerAspect.controllerPointCut()")
	 ...
	 * -后置通知
	 */
	@After(value="com.hqyj.springBootTest.aspect.ControllerAspect.controllerPointCut()")
